    ...
    <form action={formAction}>
      <div className="grid md:grid-cols-12 gap-5">
        ...
        <div className="col-span-4 bg-white p-4">
          <label
            htmlFor="input-file"
            className="flex flex-col mb-4 items-center justify-center aspect-video border-2 border-gray-300 border-dashed 
            rounded-md cursor-pointer bg-gray-50 relative"
          >
          ...
          <button
            ...
            className={clsx(
              ...
              {
                "opacity-50 cursor-progress": isPending || pending,
              }
            )}
